                ...
                <div className="2xl:w-4/5 ">
                    ...
                    <div className="mt-7 relative">
                        <input
                            ...
                            className="h-[58px] border border-gray-400 w-full px-5 font-ProximaNovaMed text-lg outline-none rounded-lg text-[#282c3f]"
                        />
                    ...
                    <div className="text-shadow">
                        <p className="font-ProximaNovaThin text-[15px] text-white lg:text-gray-600 font-bold mt-7 mb-2">
                            Find your location to sign up for daily menus,
                        ...
                        <div className="lg:text-[#686b78] text-white text-base font-ProximaNovaSemiBold flex flex-wrap">
                            ...
                            <span className="mr-2 lg:text-[#93959f]">
                                Bangalore
                            </span>
